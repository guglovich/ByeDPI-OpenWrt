...
combo_ladder_auto|--timeout 3 --auto-mode s,n -d1 -s1+s -d3+s -s6+s -d9+s -s12+s -d15+s -s20+s -d25+s -s30+s -a1 --auto=torst --fake -1 --ttl 8
combo_fake_auto|--timeout 3 --auto-mode s,n --fake -1 --ttl 8 --auto=torst --split 1 --disorder 3+s
"
